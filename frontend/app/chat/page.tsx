  ...
  const handleSend = async (textToSend: string) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (isProFeature) {
          addChatMessage("public", "⚡ This feature requires a **Pro plan**. Nanopayments and paid marketplace services are exclusive to Pro subscribers. Upgrade to unlock real-time data, web search, crypto prices, and more.", "agent");
          showUpgradeModal(
            "Pro Plan Required",
          ...
          addChatMessage("public", `⚠️ ${msg}`, "agent");
          showUpgradeModal("Quota Exceeded", msg);
        } else {
          addChatMessage("public", `⚠️ ${msg || "The explorer agent is currently unavailable."}`, "agent");
        }
        return;
      }
